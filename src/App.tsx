...
const AppContent = () => {
  ...
  return (
    <div className={`w-full ${isAdminRoute ? 'max-w-none' : 'max-w-[390px] md:max-w-none'} mx-auto min-h-screen bg-[#FAFAFA] flex flex-col relative overflow-x-hidden shadow-2xl md:shadow-none`}>
      <Toaster />
      <Sonner />
